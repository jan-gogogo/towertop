# GameFI - TowerTop 设计文档

---

## 一、游戏概述

TowerTop 是一款爬塔游戏：共 100 层，玩家从第 1 层开始，通过击败小怪获取经验并升级，击败楼层所有小怪进入下一层。 每 5 层会有一名 BOSS，战胜 BOSS 后才能进入下一段楼层。
...
| blockChance | 格挡率 | 0–100，一定几率减免部分伤害 |
| stunChance | 眩晕率 | 0–100，一定几率使对方本回合无法行动 |
